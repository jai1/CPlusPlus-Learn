...
/*
	a. Integrating libcurl with asio - CLOSESOCKET cb option not present
    b. NOT Reusing sockets - check for rmsock and Close socket function calls
    c. Not resusing sockets ensures 1:1 mapping b/w boost tcp sock and curl sock hence done't use CLOSESOCKET_FUNC
*/
/***************************************************************************
 *                                  _   _ ____  _
 *  Project                     ___| | | |  _ \| |
